...
var title, btn_help;                                                                // Titel des Spiels
...
class Start extends Phaser.Scene{
    ...
    */
    ...
    preload(){
        ...
        this.load.image('Help_Button', 'assets/help.png')
    }
    ...
    create() {    
        ...
        */
        ...
        btn_help = this.add.image(game.config.width - 50, 50, 'Help_Button');
        btn_help.setScale(0.1);
        btn_help.setInteractive();
        btn_help.on('pointerdown', () => {
